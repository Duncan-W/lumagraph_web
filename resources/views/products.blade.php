            ...
            <div class="mx-auto mb-8 text-center lg:mb-12">
                ...
                <div class="w-full flex items-center justify-center space-x-4 md:flex-row flex-wrap">
                    ...
                    <div class="text-center">
                        <svg class="w-24 h-24 mx-auto hover:drop-shadow-lg" fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                    ...
                    <div class="text-center">
                    <svg class="w-24 h-24 mx-auto hover:drop-shadow-lg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                            viewBox="0 0 463 463">
                        <g>
                            <g>
                                <g>
