    ...
    <section class="bg-white dark:bg-gray-900 lg:-mt-16" >
        ...
        <div class="max-w-screen-xl px-4 mx-auto lg:py-12 lg:px-6 lg:-mt-8">
            <div class="flex justify-center w-full mb-8 ">
                <img src="{{asset('images/meeting.avif')}}" alt="Feature Image" class="w-3/4 mb-5 h-auto rounded shadow-xl shadow-blue-gray-900/50">
            </div>
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
                    <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                        ...
                        <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Large or small, your enterprise can find means to streamline operations and improve efficiency with automation and intelligence solutions.</p>
                    </div>
