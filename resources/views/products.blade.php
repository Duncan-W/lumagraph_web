...
@section('content')
        ...
        <div class="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
            ...
            <div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-2xl font-bold dark:text-white">Fixed prices </h3>
                    <p class="font-light text-gray-500 dark:text-gray-400">Clear contracts and schedules</p>
                </div>
                <div>
                    ...
                    <h3 class="mb-2 text-2xl font-bold dark:text-white">Cloud experts</h3>
                    <p class="font-light text-gray-500 dark:text-gray-400">PAAS and SAAS options via AWS</p>
                </div>
            </div>
        </div>
      </section>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 mx-auto lg:py-12 lg:px-6">
            <div class="max-w-screen-md max-w-full mx-auto mb-8 text-center lg:mb-12">
                ...
                <div class="w-full flex items-center justify-center space-x-4 md:flex-row">
                    
                    <div class="text-center">
                        <svg class="w-24 h-24 mx-auto" fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                        ...
                        <p class="text-sm mt-2">Contact and Discovery</p>
                    </div>
                    ...
                    <div class="text-center">
                    <svg class="w-24 h-24 mx-auto" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                            viewBox="0 0 463 463">
                        <g>
                            <g>
                                <g>
                        ...
                        <p class="text-sm mt-2">Proposal Finalisation</p>
                    </div>
