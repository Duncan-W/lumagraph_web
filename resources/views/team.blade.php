...
@section('content')
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          ...
          <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Here at Lumagraph  our team and collaborators have wide experience in development and artificial intelligence innovation.</p>
      </div> 
      <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="p-5">
                  ...
                  <ul class="flex space-x-4 sm:mt-0">
                      ...
                      <li>
                          <a href="https://github.com/russellw" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="p-5">
                  ...
                  <ul class="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="https://www.linkedin.com/in/duncan-wallace-dub/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                              
                              <svg class="w-5 h-5" fill="currentColor"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
