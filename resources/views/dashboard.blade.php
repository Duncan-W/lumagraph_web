    ...
    <div class="flex justify-center pt-20">
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-3">
                        ...
                        <input type="text" id="postId" name="id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight bg-gray-200 cursor-not-allowed"  placeholder="URL encoded title" required readonly>
            </div>
            <div class="mb-4">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        titleInput.addEventListener('input', function () {
            ...
            // Remove all non-alphanumeric characters (including punctuation and symbols)
            postIdValue = postIdValue.replace('&', 'and');
            postIdValue = postIdValue.replace(/[^a-z0-9-]/g, '-');
