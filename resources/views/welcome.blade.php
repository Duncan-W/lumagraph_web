...
<!-- Login modal -->
<div id="loginModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50  h-full md:inset-0 h-modal lg:max-w-lg" style="margin:auto">
        <div class="relative  p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <button data-modal-toggle="loginModal" class="mt-4 text-red-500 hover:underline">Close</button> 
                </div>
    <!-- Login footer -->
            </div>
        </div>
    ...
    <div class="relative  p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="phoneModal">
                    <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    <span class="sr-only">Close contacts</span>
                </button>
            </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <button data-modal-toggle="phoneModal" class="mt-4 text-red-500 hover:underline">Close</button> 
            </div>
<!-- Login footer -->
        </div>
    </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        ...
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            ...
            <div class="lg:mt-0 lg:col-span-5 lg:flex">
                ...
                <video id="myVideo" autoplay="1" muted="1"> <source src="{{ asset('images/AdobeStock_257066146.mp4') }}"></video>
                <script>
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    ...
                    <p class="font-light lg:text-xl">Lumagraph boasts prompt online responses and site visits for businesses located in Dublin.</p>
                </div>
            </div>
        </div>
      </section>
