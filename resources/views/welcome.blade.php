...
<!-- Main modal -->
<div id="defaultModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 h-full md:inset-0 h-modal">
        ...
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    ...
                    <button data-modal-toggle="defaultModal" id="phoneButton" class="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:w-auto focus:outline-none hover:bg-gray-100 hover:text-blue-800 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-800">
...
HTMLVideoElement.prototype.playBackwards = function () {
    ...
    <!-- End block -->
    <!-- Start block -->
    <section class="bg-gray-50 dark:bg-gray-900 hidden">
